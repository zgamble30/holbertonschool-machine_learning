...
def projection_block(A_prev, filters, s=2):
    ...
    # Shortcut path
    shortcut = K.layers.Conv2D(F12, kernel_size=(1, 1), strides=(s, s),
                               kernel_initializer='he_normal')(A_prev)
    shortcut = K.layers.BatchNormalization(axis=3)(shortcut)

    # Main path
    conv1 = K.layers.Conv2D(F11, kernel_size=(1, 1), strides=(s, s),
                             kernel_initializer='he_normal')(A_prev)
    ...
    conv3 = K.layers.Conv2D(F12, kernel_size=(1, 1),
