...
def l2_reg_gradient_descent(Y, weights, cache, learning_rate, lambda_param, num_layers):
    """
    ...
    for layer in range(num_layers, 0, -1):
        ...
        dW = np.matmul(dZ, A_previous_layer.T) / num_samples + l2_regularization_term
