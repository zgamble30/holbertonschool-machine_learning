...
def conv_forward(A_prev, W, b, activation, padding="same", stride=(1, 1)):
   ...
   padding (str, optional): Type of padding, can be "same" or "valid". 
   Default is "same"
   stride (tuple, optional): Tuple indicating stride in height and width 
   direction. Default is (1, 1)
   ...
   for h in range(output_height):
       for w in range(output_width):
           for c in range(c_new):
               ...
               a_slice_prev = A_prev_pad[:, filter_start_height:filter_end_height, 
