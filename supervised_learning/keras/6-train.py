...
def train_model(network, data, labels, batch_size, epochs, 
    ...
    """
    Trains a model using mini-batch gradient descent with optional validation data and early stopping.
    ...
    - validation_data: a tuple (X_valid, Y_valid) containing validation data, where X_valid is the input data
      and Y_valid is the labels for validation. Default is None.
    - early_stopping: a boolean that indicates whether early stopping should be used. Default is False.
