...
def precision(confusion):
    ...
    Args:
        confusion: a numpy.ndarray of shape (classes, classes) representing the confusion matrix
        where row indices represent the correct labels and column indices represent the predicted labels.
    Returns:
